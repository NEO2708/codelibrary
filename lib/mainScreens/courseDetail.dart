  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: context.screenWidth >= 860
                          ...
                          child:
                            ...
                            Container(
                                ...
                                decoration: BoxDecoration(
                                    color: cardBgcolor,
                                    borderRadius: BorderRadius.circular(30)),
                                child: CourseInfo(title: title,price: price,)),
                          ])),
                    )
                  ],
                ),
          ...
          : MobileCourseDetail(title: title,price: price,),
...
class CourseInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.all(30),
      decoration: BoxDecoration(
          color: cardBgcolor, borderRadius: BorderRadius.circular(30)),
      child: Column(
         ...
         "₹ ${price}"
          ...
          TextButton.icon(
              ...
              icon: Icon(Icons.play_arrow_outlined)
                  ...
                  .iconSize(30),
              label: "Preview Course".text.xl2.bold.color(simpleWhite).make()),
          SizedBox(
            height: 20,
          ),
          Wrap(
            children: [
              Row(
                children: [
                  Icon(Icons.bar_chart).iconSize(30).iconColor(simpleWhite),
                  SizedBox(
                    width: 10,
                  ),
                  "Level             : All"
              ...
              Row(
                children: [
                  Icon(Icons.person).iconSize(30).iconColor(simpleWhite),
                  SizedBox(
                    width: 10,
                  ),
                  "Lessons        :108".text.color(simpleWhite).xl2.bold.make(),
                ],
              ),
              SizedBox(
                height: 40,
              ...
              Row(
                children: [
                  Icon(Icons.abc).iconSize(30).iconColor(simpleWhite),
                  SizedBox(
                    width: 10,
                  ),
                  "Languages  : English"
...
class MobileCourseDetail extends StatelessWidget {
final String title;
final String price;
...
class DesktopCourseDetail extends StatelessWidget {
  const DesktopCourseDetail({super.key});
